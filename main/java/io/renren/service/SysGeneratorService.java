...
public class SysGeneratorService {
    ...
    public byte[] generatorCode(String[] tableNames,String author,String packagePath) {
        ...
        for (String tableName : tableNames) {
            ...
            //生成代码
            GenUtils.generatorCode(table,author,packagePath, columns, zip);
        }
        if (MongoManager.isMongo()) {
            GenUtils.generatorMongoCode(tableNames,author,packagePath, zip);
        }
