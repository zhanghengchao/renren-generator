...
public class GenUtils {
    ...
    public static List<String> getTemplates() {
        ...
        templates.add("template/QueryParamDTO.java.vm");
     ...
     * 生成代码
     */
    public static void generatorCode(Map<String, String> table,String author,String packagePath,
        ...
        map.put("moduleName", packagePath);
        ...
        for (String template : templates) {
            ...
            try {
                //添加到zip
                zip.putNextEntry(new ZipEntry(getFileName(template, tableEntity.getClassName(), config.getString("package"), packagePath,author)));
     ...
     * 生成mongo其他实体类的代码
     */
    public static void generatorMongoCode(String[] tableNames,String author,String packagePath, ZipOutputStream zip) {
        for (String tableName : tableNames) {
            ...
            for (MongoGeneratorEntity mongoGeneratorEntity : childrenInfo) {
                generatorChildrenBeanCode(mongoGeneratorEntity,packagePath,author, zip);
            }
        }
    }

    private static void generatorChildrenBeanCode(MongoGeneratorEntity mongoGeneratorEntity,String packagePath,String author, ZipOutputStream zip) {
        //配置信息
        Configuration config = getConfig();
        boolean hasList = false;
        //表信息
     ...
     * 获取文件名
     */
    public static String getFileName(String template, String className, String packageName, String moduleName,String author) {
        ...
        if (template.contains("QueryParamDTO.java.vm") ) {
            return packagePath + "dto" + File.separator + className + "QueryParamDTO.java";
